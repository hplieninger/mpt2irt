...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(224, 224, "end", "model_stan_boeck_ext2");
    return reader;
}
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        Eigen::Matrix<T__,Eigen::Dynamic,Eigen::Dynamic>  beta(static_cast<Eigen::VectorXd::Index>(J),static_cast<Eigen::VectorXd::Index>(5));
        (void) beta;  // dummy to suppress unused var warning
        ...
        vector<vector<T__> > extreme_a(N, (vector<T__>(J)));
        stan::math::initialize(extreme_a, DUMMY_VAR__);
        stan::math::fill(extreme_a,DUMMY_VAR__);
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int j = 1; j <= J; ++j) {
                    ...
                    stan::math::assign(get_base1_lhs(get_base1_lhs(trait,i,"trait",1),j,"trait",2), Phi_approx((pow(-(1),get_base1(revItem,j,"revItem",1)) * (get_base1(theta,i,(3 + get_base1(traitItem,j,"traitItem",1)),"theta",1) - get_base1(beta,j,4,"beta",1)))));
                    current_statement_begin__ = 120;
                    stan::math::assign(get_base1_lhs(get_base1_lhs(extreme_a,i,"extreme_a",1),j,"extreme_a",2), Phi_approx((get_base1(theta,i,2,"theta",1) - get_base1(beta,j,5,"beta",1))));
                    current_statement_begin__ = 123;
                    stan::math::assign(get_base1_lhs(get_base1_lhs(get_base1_lhs(p_cat,i,"p_cat",1),j,"p_cat",2),1,"p_cat",3), ((((1 - get_base1(get_base1(acquies,i,"acquies",1),j,"acquies",2)) * (1 - get_base1(get_base1(middle,i,"middle",1),j,"middle",2))) * (1 - get_base1(get_base1(trait,i,"trait",1),j,"trait",2))) * get_base1(get_base1(extreme,i,"extreme",1),j,"extreme",2)));
                    current_statement_begin__ = 124;
                    stan::math::assign(get_base1_lhs(get_base1_lhs(get_base1_lhs(p_cat,i,"p_cat",1),j,"p_cat",2),2,"p_cat",3), ((((1 - get_base1(get_base1(acquies,i,"acquies",1),j,"acquies",2)) * (1 - get_base1(get_base1(middle,i,"middle",1),j,"middle",2))) * (1 - get_base1(get_base1(trait,i,"trait",1),j,"trait",2))) * (1 - get_base1(get_base1(extreme,i,"extreme",1),j,"extreme",2))));
                    ...
                    stan::math::assign(get_base1_lhs(get_base1_lhs(get_base1_lhs(p_cat,i,"p_cat",1),j,"p_cat",2),4,"p_cat",3), (((((1 - get_base1(get_base1(acquies,i,"acquies",1),j,"acquies",2)) * (1 - get_base1(get_base1(middle,i,"middle",1),j,"middle",2))) * get_base1(get_base1(trait,i,"trait",1),j,"trait",2)) * (1 - get_base1(get_base1(extreme,i,"extreme",1),j,"extreme",2))) + (get_base1(get_base1(acquies,i,"acquies",1),j,"acquies",2) * (1 - get_base1(get_base1(extreme_a,i,"extreme_a",1),j,"extreme_a",2)))));
                    current_statement_begin__ = 127;
                    stan::math::assign(get_base1_lhs(get_base1_lhs(get_base1_lhs(p_cat,i,"p_cat",1),j,"p_cat",2),5,"p_cat",3), (((((1 - get_base1(get_base1(acquies,i,"acquies",1),j,"acquies",2)) * (1 - get_base1(get_base1(middle,i,"middle",1),j,"middle",2))) * get_base1(get_base1(trait,i,"trait",1),j,"trait",2)) * get_base1(get_base1(extreme,i,"extreme",1),j,"extreme",2)) + (get_base1(get_base1(acquies,i,"acquies",1),j,"acquies",2) * get_base1(get_base1(extreme_a,i,"extreme_a",1),j,"extreme_a",2))));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void write_array(RNG& base_rng__,
        ...
        validate_non_negative_index("beta", "J", J);
        validate_non_negative_index("beta", "5", 5);
        matrix_d beta(static_cast<Eigen::VectorXd::Index>(J),static_cast<Eigen::VectorXd::Index>(5));
        (void) beta;  // dummy to suppress unused var warning
        ...
        validate_non_negative_index("extreme_a", "N", N);
        validate_non_negative_index("extreme_a", "J", J);
        vector<vector<double> > extreme_a(N, (vector<double>(J, 0.0)));
        stan::math::initialize(extreme_a, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(extreme_a,DUMMY_VAR__);
