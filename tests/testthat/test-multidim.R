...
test_that("tidyup_irtree_fit() returns correlations", {
    ...
    expect_equal(unique(as.vector(sapply(res2c$Corr, dim))), res1b$args$S)
    expect_equal(unique(as.vector(sapply(res3c$Corr, dim))), res1b$args$S)
    expect_equal(unique(as.vector(sapply(res4c$Corr, dim))), res1b$args$S)
    expect_equal(unique(as.vector(sapply(res5c$Corr, dim))), res1b$args$S)
    expect_equal(unique(as.vector(sapply(res6c$Corr, dim))), res1b$args$S)
    expect_equal(unique(as.vector(sapply(res1c$Sigma, dim))), res1b$args$S)
    expect_equal(unique(as.vector(sapply(res2c$Sigma, dim))), res1b$args$S)
    expect_equal(unique(as.vector(sapply(res3c$Sigma, dim))), res1b$args$S)
    expect_equal(unique(as.vector(sapply(res4c$Sigma, dim))), res1b$args$S)
    expect_equal(unique(as.vector(sapply(res5c$Sigma, dim))), res1b$args$S)
    expect_equal(unique(as.vector(sapply(res6c$Sigma, dim))), res1b$args$S)
})
